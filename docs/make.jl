...
makedocs(;
    ...
    format=Documenter.HTML(;
        prettyurls=get(ENV, "CI", "false") == "true", canonical="https://FraCpl.github.io/KalmanFilterEngine.jl", edit_link="master", assets=String[]
    ),
    pages=["Home" => "index.md"],
)

deploydocs(; repo="github.com/FraCpl/KalmanFilterEngine.jl", devbranch="master")
